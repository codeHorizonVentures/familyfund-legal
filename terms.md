...
Apple has no obligation to provide maintenance or support services for FamilyFund.
...
- Use FamilyFund for personal budgeting, planning, and expense tracking

- Enable iCloud sync to synchronize your data across your Apple devices
...
- Copy, distribute, sublicense, rent, lease, or sell the app except as expressly allowed by law

- Interfere with the app, its security features, or related Apple services
...
### **4.1 FamilyFund Premium**

FamilyFund offers an optional Premium subscription with additional features made available in the app at the time of purchase.


### **4.2 Subscription Processing**

- Subscriptions are processed through the Apple App Store using StoreKit

- Apple handles billing and payment processing

- Charges are applied to your Apple account

- Prices, billing periods, and any introductory offers are shown by Apple before purchase


### **4.3 Automatic Renewal**

- Auto-renewable subscriptions renew automatically unless cancelled

- Renewal timing and billing are handled by Apple under your Apple account settings


### **4.4 Cancellation**

You may cancel your subscription at any time through your Apple account subscription settings.

Cancellation normally takes effect at the end of the current billing period unless Apple states otherwise.


### **4.5 Refunds**

- Refund requests for App Store purchases are handled by Apple because Apple is the merchant of record for those purchases

- You can request a refund through Apple Support: <https://support.apple.com/billing>

- Nothing in these Terms limits any non-waivable consumer rights you may have under applicable law


### **4.6 Introductory Offers, Promotional Offers, and Offer Codes**

If made available, introductory offers, promotional offers, and offer codes may be subject to eligibility rules, storefront availability, Apple account restrictions, and Apple's own policies.
...
FamilyFund is a budgeting and expense-tracking tool for informational and personal planning purposes only. It does not provide:
...
- Financial decisions made based on the app's information
...
- The financial data you enter remains your data

- We do not claim ownership of your transaction records, budgets, or notes

- You may edit or delete your data at any time inside the app, subject to the app's functionality and Apple platform behavior
...
For information about how FamilyFund processes data, please see the [**Privacy Policy**](https://familyfund.app/privacy).
...
FamilyFund relies on Apple platform services and may use third-party services needed for app functionality, such as exchange-rate data services.
